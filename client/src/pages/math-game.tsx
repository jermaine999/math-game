    ...
    <div className="min-h-screen bg-gradient-to-br from-skyblue to-turquoise flex items-center justify-center p-4" onKeyPress={handleKeyPress}>
      <div className="bg-white rounded-3xl shadow-2xl p-8 w-full max-w-2xl text-center">
        <div className="mb-6">
          ...
          <br />
          <br />
          <div className="text-2xl font-fredoka text-darkblue">
            {playerName} <span className="mx-8"></span> +{currentScore} points
          </div>
        </div>
        ...
        {/* Leaderboard */}
        <div className="mb-8">
          <h3 className="text-xl font-fredoka text-darkblue mb-4">Top Scores - {gameModeConfig[selectedGameMode].name}</h3>
